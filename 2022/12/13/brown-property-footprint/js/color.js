...
class ColorSpace {
	constructor (options) {
		...
		this._path = this._getPath().reverse();
	...
	getFormat (format) {
		if (typeof format === "object") {
			format = this._processFormat(format);
			return format;
		}
	...
	to (space, coords) {
		...
		let myPath = this._path;
		let otherPath = space._path;
...
class Color {
	...
	constructor (...args) {
		...
		this._space = ColorSpace.get(space);
		...
		for (let id in this._space.coords) {
