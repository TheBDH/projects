document.addEventListener('DOMContentLoaded', () => {
    const db = {
        games: [
            ...
            { date: 'February 28th', teams: ['Brown', 'Harvard'], winner: 'Brown' },
            { date: 'February 28th', teams: ['Yale', 'Dartmouth'], winner: 'Yale' },
            { date: 'February 28th', teams: ['Penn', 'Cornell'], winner: 'Cornell' },
            { date: 'February 28th', teams: ['Princeton', 'Columbia'], winner: 'Princeton' },
        ...
        womenGames: [
            ...
            { date: 'February 28th', teams: ['Brown', 'Columbia'], winner: 'Columbia' },
            { date: 'February 28th', teams: ['Yale', 'Cornell'], winner: 'Yale' },
            { date: 'February 28th', teams: ['Penn', 'Dartmouth'], winner: 'Penn' },
            { date: 'February 28th', teams: ['Princeton', 'Harvard'], winner: 'Princeton' },
            { date: 'March 1st', teams: ['Yale', 'Columbia'], winner: 'Columbia' },
