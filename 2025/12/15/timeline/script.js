...
scroller
  ...
  .onStepEnter((response) => {
    timelineStep1.classed("is-active", false);
    // otherNewsStep.classed("is-visible", false);

    if (response.index >= 2) {
      // if (response.index <= 8) {
      //   timelineStep2.classed("is-visible", false);
      //   timelineStep1.classed("is-visible", true);
      // } else {
      //   timelineStep1.classed("is-visible", false);
      //   timelineStep2.classed("is-visible", true);
      // }
      timelineStep1.classed("is-visible", true);
